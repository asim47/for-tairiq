...
function Settings() {
    ...
    useEffect(() => {
        if (UserObject) {
            setYourName(UserObject.user_name)
            setEmail(UserObject.email)
            setDOB(UserObject.date_of_birth || new Date().toISOString())
            setPresentAddress(UserObject.present_address || "")
            setPermenantAddress(UserObject.permanent_address || "")
            setCity(UserObject.city || "")
            setPostalCode(UserObject.postal_code || 0)
    ...
    async function saveData() {
        ...
        const newObj = {
            ...
            "user_name": YourName,
            "email": Email,
            "date_of_birth": "2020-11-25T15:01:27.871Z",
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className="form-row">
                                                <div className="form-group col-xl-6">
                                                    ...
                                                    <input
                                                        value={YourName}
                                                        onChange={({ target }) => setYourName(target.value)}
                                                ...
                                                {/* <div className="form-group col-xl-6">
                                                    <label
                                                        ...
                                                        className="mr-sm-2">Date of birth</label>
                                                    <input
                                                        value={DOB}
                                                        onChange={({ target }) => setDOB(target.value)}
                                                        type="text" className="form-control" placeholder="10-10-2019"
                                                ...
                                                <div className="form-group col-xl-6">
                                                    ...
                                                    <input
                                                        ...
                                                        onChange={({ target }) => setPermenantAddress(target.value)}
                                                        type="text" className="form-control"
                                                ...
                                                <div className="form-group col-xl-6">
                                                    ...
                                                    <input
                                                        ...
                                                        type="text" className="form-control" placeholder="000000"
                                                        name="postal" />
                                                </div>
                                                <div className="form-group col-xl-6">
