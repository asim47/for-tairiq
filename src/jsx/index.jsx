...
import ChangePasswordWithVerify from './pages/changePasswordWithVerify';
            ...
            <BrowserRouter basename={'/'}>
                <div id="main-wrapper">
                    <Switch>
                        <Route exact path='/' >
                            <Signin
                                setUserObject={(e) => setUserObject(e)}
                            />
                        ...
                        <Route path='/change-pass' component={ChangePasswordWithVerify} />
                    </Switch>
                </div>
            </BrowserRouter>
